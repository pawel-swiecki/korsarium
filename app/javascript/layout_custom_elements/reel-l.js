class Reel extends HTMLElement {
  ...
  set itemWidth(val) { this.setAttribute('itemWidth', val); }
  get height() { return this.getAttribute('height') || 'auto'; }
  set height(val) { this.setAttribute('height', val); }
  get space() { return this.getAttribute('space') || 'var(--space-m)'; }
  set space(val) { this.setAttribute('space', val); }
  get noBar() { return this.hasAttribute('noBar'); }
  set noBar(val) { val ? this.setAttribute('noBar', '') : this.removeAttribute('noBar'); }
  static get observedAttributes() { return ['itemWidth', 'height', 'space', 'noBar']; }
